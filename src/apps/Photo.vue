  ...
  <div class="photos-app flex h-full bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 overflow-hidden font-sans">
    ...
    <div class="w-16 md:w-56 bg-gray-50/50 dark:bg-gray-900/50 backdrop-blur-xl border-r border-gray-200 dark:border-gray-800 flex flex-col">
      <div class="p-6 hidden md:block">
        ...
        <p class="text-xs text-gray-500 mt-1">你的个人影像库</p>
      </div>
      ...
      <nav class="flex-1 px-3 space-y-1">
        <button
          ...
          :class="currentTab === item.id ? 'bg-accent text-white font-semibold' : 'hover:bg-gray-200/50 dark:hover:bg-gray-800/50 text-gray-500 dark:text-gray-400'"
        >
      ...
      <div class="p-4 mt-auto">
        <div class="hidden md:block p-3 rounded-2xl bg-gradient-to-br from-accent/10 to-purple-500/10 border border-accent/10">
          <p class="text-[10px] uppercase tracking-wider font-bold text-accent mb-1">存储空间</p>
          <div class="h-1.5 w-full bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
            <div class="h-full bg-accent w-2/3"></div>
          </div>
        ...
        <div class="flex items-center space-x-4">
          <div class="relative">
            ...
            <input
              ...
              class="pl-10 pr-4 py-2 bg-gray-100 dark:bg-gray-800 border-none rounded-full text-sm w-48 md:w-80 focus:ring-2 focus:ring-accent/50 outline-none transition-all"
            />
          </div>
        </div>
      ...
      <div v-if="selectedPhoto" class="fixed inset-0 z-[100] bg-black/95 backdrop-blur-2xl flex flex-col">
        ...
        <div class="h-24 px-6 overflow-x-auto flex items-center space-x-2 justify-center py-4">
          <div
            ...
            :class="selectedPhoto.id === p.id ? 'ring-2 ring-accent scale-110' : 'opacity-40 hover:opacity-100'"
          >
...
const photos = ref([
  ...
  { id: 2, url: 'https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=800&q=80', location: 'Rocky Mountains', time: '11:15 AM' },
  ...
  { id: 4, url: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=800&q=80', location: 'Misty Valley', time: '04:12 PM' },
  ...
  { id: 6, url: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=800&q=80', location: 'Redwood Forest', time: '昨天 09:00 AM' },
